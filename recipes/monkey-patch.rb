    ...
    if node["platform"]=='ubuntu' && node["platform_version"].to_f>=14.04
        ...
        node["upstart"]["services"].each do |monkey_patch|
            ...
            begin
                ...
                Chef::Log.info( "Monkey patching service resource '#{monkey_patch}'" +
                    "to use '::Chef::Provider::Service::Upstart' provider")

            rescue Exception => msg

                Chef::Log.info( "Skipping monkey patching service resource '#{monkey_patch}' " +
