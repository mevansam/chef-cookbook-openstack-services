...
cookbook 'openstack-image',          git: 'https://github.com/mevansam/cookbook-openstack-image.git',         branch: 'stable/icehouse'
cookbook 'openstack-block-storage',  git: 'https://github.com/mevansam/cookbook-openstack-block-storage',     branch: 'stable/icehouse'
cookbook 'openstack-compute',        git: 'https://github.com/mevansam/cookbook-openstack-compute.git',       branch: 'stable/icehouse'
cookbook 'openstack-dashboard',      git: 'https://github.com/mevansam/cookbook-openstack-dashboard',         branch: 'stable/icehouse'
